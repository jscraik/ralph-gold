...
- [x] Add SmartGateConfig dataclass to config.py
...
- [x] Add get_changed_files() function to gates.py
...
- [x] Add should_skip_gates() function to gates.py
...
- [x] Integrate smart gates into loop execution
...
- [x] Add --hotfix and --task flags to CLI
...
- [x] Add [QUICK] tag detection to PRD parser
...
- [x] Add get_quick_batch() function to tracker
